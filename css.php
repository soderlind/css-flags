...
if ( false === ( $css_flags = get_site_transient( "css-flags-all-countries" ) ) ) {
	$css_flags_json = file_get_contents( esc_url( $css_flags_data_path  . '/data/flags.json' ) );
	$css_flags = json_decode( $css_flags_json, true );

	set_site_transient( "css-flags-all-countries", $css_flags,  $css_flags_cachetime );
}

if ( false === ( $css_flags_regions = get_site_transient( "css-flags-all-regions" ) ) ) {
	...
	set_site_transient( "css-flags-all-regions", $css_flags_regions, $css_flags_cachetime );
}
