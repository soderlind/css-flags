...
The CSS Flags [plugin](#plugin) / [library](#theme) for WordPress loads a [dynamicly created CSS](https://github.com/soderlind/css-flags/blob/master/css-flags.php#L21-L39). It has responsive [SVG](http://en.wikipedia.org/wiki/Scalable_Vector_Graphics) flags for the following countries:
